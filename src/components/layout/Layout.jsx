...
function Layout() {
  return (
    <div className={`min-h-screen p-8 bg-[#313b47]`}>
      <main className="max-w-[1000px] mx-auto bg-white">
        {/* Header Section */}
        <header className="flex gap-6 p-8  border-b-2 border-primary ">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm leading-relaxed text-black ">
              I am a computer engineer specializing in JavaScript, ReactJS frontend, and serverless technologies. With 8 years of experience in web app development across education, AI, and 3D printing
            </p>
          </div>
